package com.example.smart_scale_app_final;
...
class ConnectRunnable implements Runnable {
    ...
    public ConnectRunnable(BluetoothAdapter adapter, @NotNull BluetoothDevice device, ProgressDialog dialog2) throws IOException {
